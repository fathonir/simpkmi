...
{	
	...
	{
		return $this->db
			->select('ap.id, ap.mahasiswa_id, coalesce(m.nim, ap.nim) as nim, coalesce(m.nama, ap.nama) as nama')
			->select('ap.no_hp, m.program_studi_id, ps.nama as nama_program_studi')
