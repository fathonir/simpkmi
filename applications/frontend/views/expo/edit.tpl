				...
				<fieldset>
                    ...
                    {if $kegiatan->tahun == 2021}
						<div class="form-group">
							...
							<div class="col-lg-4">
								{$is_hadir_offline=set_value('is_hadir_offline', $proposal->is_hadir_offline)}
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<input name="rekening" type="text" class="form-control" value="{set_value('rekening', $proposal->rekening)}" />
